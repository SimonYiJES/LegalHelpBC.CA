...
if (version_compare(PHP_VERSION, '7.0.4') < 0) {
  print 'Your PHP installation is too old. Drupal requires at least PHP 7.0.4. See the <a href="https://www.drupal.org/requirements">system requirements</a> page for more information.';
  exit;
}
