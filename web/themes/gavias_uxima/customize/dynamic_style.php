...
?>
    ...
    <?php if(isset($customize['font_family_second'])  && $customize['font_family_second'] != '---'){ ?>
        ...
        label,.pager ul.pager__items > li a,header .header-info .content-inner,.post-block .post-title,.post-block .post-categories a,.team-block.team-v1 .team-content .team-name,.team-block.team-v1 .team-skills .progress-label,
        .team-block.team-v2 .team-image .team-content .team-name,.text-size-medium,.text-medium,.button, .btn, .btn-white, .btn-theme, .btn-theme-second, .more-link a, .btn-theme-submit,.btn-inline,.progress-label,.pricing-table .plan-name .title,
        .pricing-table .content-wrap .plan-price .price-value .value,.pricing-table .content-wrap .plan-price .interval,.pricing-vertical ul > li,.pricing-vertical div[class*='col-'] .pricing-title .pricing-price .pricing-dollar,.pricing-vertical div[class*='col-'] .pricing-title .pricing-price .price,
        #node-single-comment h2,form summary,.user-login-form .form-item label, .user-register-form .form-item label, .user-form .form-item label, .user-pass .form-item label,form .mailchimp-newsletter-mergefields .form-item label,.block .block-title,.contact-link .title,.company-presentation .title,.box-search-team .text,
        .navigation .gva_menu > li > a,.navigation .gva_menu .megamenu > .sub-menu > li > a, .navigation .gva_menu .gva-mega-menu > .sub-menu > li > a,.navigation .gva_menu .sub-menu > li > a,.category-list .item-list ul li a,.tags-list .item-list > ul > li a,.gbb-row-wrapper .row-text-overlay,#fp-nav ul li .fp-tooltip,.gsc-call-to-action .sub-title,
        .gsc-carousel-content .item .item-content .content-box-wrapper .content-box .content-inner .caption-title,.gsc-carousel-content .item .item-content .content-box-wrapper .content-box .content-inner .caption-description,.gsc-icon-box .highlight_content .title,.milestone-block.position-icon-top .milestone-text,.milestone-block.position-icon-left .milestone-right .milestone-text,
        .milestone-block.position-icon-left-2 .milestone-right .milestone-text,.gsc-content-images-parallax.style-v1 .content .title,.gsc-content-images-parallax.style-v2 .content .title,.gsc-video-box.style-1 .image .popup-video,.gsc-video-box.style-1 .video-content .left,.gsc-video-box.style-2 .image .popup-video,.gsc-video-box.style-2 .video-content .link-video,.gsc-video-box.style-2 .video-content .link-video strong,
        .gsc-video-box.style-2 .video-content .button-review a,.gsc-team .team-name,.gsc-team.team-vertical .team-name,.gsc-team.team-circle .team-name,.gsc-quotes-rotator .cbp-qtrotator .cbp-qtcontent .content-title,.gva-job-box .content-inner .job-type,.gva-job-box .content-inner .box-title .title,.gsc-our-gallery .item .box-content .title,.gsc-box-hover .backend .box-title,.gsc-box-hover .backend .link-action a,.gsc-box-hover .box-title,
        .gsc-text-rotate .rotate-text .primary-text,.gsc-heading .sub-title,.gsc-chart .content .title,.gsc-tabs .tabs_wrapper.tabs_horizontal .nav-tabs > li a,.gsc-tabs .tabs_wrapper.tabs_vertical .nav-tabs > li a,.gsc-service-carousel .item .content-inner .title a,.gva-offcanvas-mobile .gva-navigation .gva_menu > li > a,.gva-offcanvas-mobile .gva-navigation .gva_menu > li ul.menu.sub-menu li a,.gva-offcanvas-mobile .gva-navigation .gva_menu > li.megamenu > .sub-menu > li > a,
        .portfolio-filter ul.nav-tabs > li > a,.portfolio-v1 .content-inner .title a,.portfolio-v1 .content-inner .category a,.portfolio-v2 .content-inner .title a,.portfolio-carousel-single .portfolio-item .images .read-more a,.portfolio-carousel-single .portfolio-item .portfolio-content .category a,.portfolio-carousel-single .portfolio-item .portfolio-content .title a,.testimonial-node-v1 .testimonial-content .title,.testimonial-node-v1 .testimonial-content .info .right .title,
        .testimonial-node-2 .title,.testimonial-node-v3 .quote,.testimonial-node-v3 .info .name,.testimonial-node-v3 .content-inner .title,.service-block .service-block-content .service-content .title,.services-tab .tab-carousel-nav .link-service,#customize-gavias-preivew .card .card-header a,#customize-gavias-preivew .form-group label
        {
    ...
    <?php if(isset($customize['body_bg_image'])  && $customize['body_bg_image']){ ?>
        body{
            background-image:url('<?php echo drupal_get_path('theme', 'gavias_uxima') .'/images/patterns/'. $customize['body_bg_image']; ?>');
        }
    <?php } ?> 
