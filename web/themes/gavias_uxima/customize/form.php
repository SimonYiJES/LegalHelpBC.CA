<div id="gavias_customize_form" class="gavias_customize_form">
   ...
   <div class="form-group action">
      ...
      <input type="hidden" id="gva_theme_name" name="theme_name" value="gavias_uxima" />
   </div>   
         ...
         <div class="card">
            ...
            <div id="customize-body" class="collapse" data-parent="#customize-accordion">
               <div class="card-body">
                  ...
                  <div class="form-wrapper">
                  <div class="desc" style="line-height: 16px;"><b>You can upload image for /themes/gavias_uxima/images/patterns</b></div>
                     <div class="form-group">
