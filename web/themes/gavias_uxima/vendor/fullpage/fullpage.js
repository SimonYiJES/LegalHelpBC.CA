...
jQuery(document).ready(function() {
    if(jQuery.fn.fullpage){
        var titleSection = [];
        jQuery('body.one-page-full .gavias-builder--content').find('.section.row-first-level').each(function(){
            titleSection.push(jQuery(this).attr('data-onepage-title'));
        });
        function initFullpage(){
            jQuery('body.one-page-full .gavias-builder--content').fullpage({
                navigation: true,
                navigationPosition: 'right',
                navigationTooltips: titleSection,
                sectionSelector: '.section.row-first-level',
                dragAndMove: true,
                //dragAndMoveKey: 'YWx2YXJvdHJpZ28uY29tX0EyMlpISmhaMEZ1WkUxdmRtVT0wWUc=',
                responsive: 991, //backwards compabitility with responsiveWiddth
                responsiveWidth: 991,
