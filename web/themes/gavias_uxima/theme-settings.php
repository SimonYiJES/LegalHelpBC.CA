 ...
 */
function gavias_uxima_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'gavias_uxima/gavias-uxima-admin';  
  ...
  $form['header']['header_button'] = array(
    '#type' => 'textfield',
    '#title' => t('Header Button Link'),
    '#default_value' => theme_get_setting('header_button'),
  );
