...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ?>
       <?php ob_start() ?>
         <script src="//maps.googleapis.com/maps/api/js?key=AIzaSyAvOhtbl4wK5vOq3YZuc-gkldJTxI13eY4"></script>
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_uxima')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . drupal_get_path('theme', 'gavias_uxima')) ?>/vendor/jquery.ui.map.min.js"></script>
